...
const DEFAULT_ACTION_CARDS = [
  ...
  { title: 'Sell Your Products', bgColor: '#fdf0cd', image: '/img/hero-cards/sell_products_3d.png', link: '/products' },
  { title: 'Grow Your Business', bgColor: '#ffd3d5', image: '/img/hero-cards/grow_business_3d.png', link: '/dashboard' },
];
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-200">
        ...
        <p className="text-gray-500 mt-1">
          ...
          <Link href={ROUTES.categories} className="text-[#006d44] font-semibold hover:underline inline-flex items-center gap-1">
            Category Management <ExternalLink size={14} />
          </Link>
          . To approve seller products go to{' '}
          <Link href={ROUTES.products} className="text-[#006d44] font-semibold hover:underline inline-flex items-center gap-1">
                ...
                <div className="space-y-2 max-h-96 overflow-y-auto">
                  ...
                  {filteredLiveProducts.length === 0 && (
                    <p className="text-sm text-gray-400">
                      ...
                      <Link href={ROUTES.products} className="text-[#006d44] font-semibold hover:underline">
                        Review products
                      </Link>
                    </p>
                  )}
